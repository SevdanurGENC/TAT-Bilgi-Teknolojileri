...
{
    public partial class frmServisTakipKayitGuncelleme : Form
    {
        private TblServisTakipBLL _TblServisTakipBLL;

        public frmServisTakipKayitGuncelleme()
        {
            InitializeComponent();
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            ServisTakip = _TblServisTakipBLL.guncelleServisTakip(Convert.ToInt32(txtID.Text),txtMarkaModel.Text, txtReferansNo.Text, txtIlgiliDepartmanKisi.Text, 
        ...
        private void frmServisTakipKayitGuncelleme_Load(object sender, EventArgs e)
        {
            Listele();
        }
