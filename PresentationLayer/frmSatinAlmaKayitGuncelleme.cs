...
{
    public partial class frmSatinAlmaKayitGuncelleme : Form
    {
        private TblSatinAlmalarBLL _TblSatinAlmalarBLL;

        public frmSatinAlmaKayitGuncelleme()
        {
            InitializeComponent();
            _TblSatinAlmalarBLL = new TblSatinAlmalarBLL();
        }

        private void frmSatinAlmaKayitGuncelleme_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            SatinAlma = _TblSatinAlmalarBLL.guncelleSatinAlma(Convert.ToInt32(txtID.Text), txtIsim.Text, txtSoyisim.Text,
